...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      ...
      I am proficient in Java, SpringBoot, JavaScript, React, Node.js, Next.js, Express.js, HTML, and CSS. 
      </Text>
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      ...
      I am also well-versed in cloud solution architecture with AWS, Azure, and Google Cloud. I am passionate about delivering high-quality software solutions that drive business results and provide exceptional user experiences.
    </Text>
  </Fragment>
);
